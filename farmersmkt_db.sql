...
INSERT IGNORE INTO manager_profiles (manager_id)
SELECT user_id FROM users WHERE role = 4;

INSERT IGNORE INTO supervisor_profiles (supervisor_id)
...
CREATE TABLE IF NOT EXISTS supervisor_report_attachments (
...
CREATE TABLE IF NOT EXISTS payment_batch_orders (
