<footer id="footer">
					...
					<div class="row py-5">
						<div class="col-md-4 col-lg-4 mb-4 mb-lg-0">
							<div class="header-logo">
								<a href="index.php">
									<img alt="Porto" src="assets/images/benny.png" style="width: 100%;">
								</a>
							</div>
						</div>
				...
				<div class="d-flex justify-content-between">
						<p class="text-center" style="margin: 0px auto; color: #000; padding: 8px 0px 15px; font-size: 15px; font-weight: 500;">© Copyright 2026. All Rights Reserved.</p>
						<p class="text-center" style="margin: 0px auto; color: #000; padding: 8px 0px 15px; font-size: 15px; font-weight: 500;">Developed by <a style="color: #0d6efd;" href="https://github.com/Stephen-Ben847" target="_blank">Kyambogo University</a></p>
					</div>
			</footer>
		</div>
