                   ...
                   <div class="col-lg-6">
					...
					<div class="col-lg-6">
						<div class="contact_form" style="box-shadow: 1px 10px 15px #ccc; border-top: 4px solid #08c; border-radius: 5px; color: #000; background: #F7F7F7; font-size: 16px; padding: 34px;">
                          ...
                          <input type="hidden" name="useremail" value="<?php echo htmlspecialchars($_SESSION['email'] ?? ''); ?>">
                            <input type="hidden" name="userphone" value="<?php echo htmlspecialchars($_SESSION['phone'] ?? ''); ?>">                          <button type="submit" name="addUser" class="btn btn-primary btn-lg btn-block">Submit Message</button>
							  	<?php }
							  ?>
