...
$activityList = mysqli_query($db, "SELECT action_type, target_type, notes, created_at FROM supervisor_activity_log WHERE actor_id = '$managerId' ORDER BY created_at DESC LIMIT 5");
?>
<style>
